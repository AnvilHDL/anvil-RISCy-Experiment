...
if {$root_dir eq "" || $build_dir eq ""} {
  error "usage: vivado_bitstream_ddr_calib_genesys2.tcl <root_dir> <build_dir> <jobs>"
}
...
set top_name     "risky_genesys2_ddr_calib_top"
set project_name "risky_genesys2_ddr_calib"
...
read_verilog -sv "$root_dir/fpga/src/risky_genesys2_ddr_calib_top.sv"
read_xdc $xdc_file
...
puts "DDR3 calibration bitstream: $build_dir/${project_name}.bit"
