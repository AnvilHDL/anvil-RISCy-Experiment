...
text = text.replace(
    ...
    "  output logic[0:0] if_req_valid_o,\n"
    "  output logic[63:0] if_req_addr_o,\n"
    "  output logic[63:0] mem_addr_o,\n"
    "  output logic[0:0] mem_req_valid_o,\n"
    "  output logic[63:0] mem_req_addr_o,\n"
    "  output logic[0:0] mem_req_write_o,\n"
    "  output logic[63:0] mem_req_wdata_o,\n"
    "  output logic[2:0] mem_req_width_o,\n"
    "  output logic[0:0] mem_read_o,\n"
    "  output logic[0:0] mem_write_o,\n"
    "  output logic[0:0] mem_mmio_read_valid_o,\n"
    "  output logic[63:0] mem_mmio_read_addr_o,\n"
...
text = text.replace(
    "endmodule",
    "  assign pc_o = pc_q_q;\n"
    "  assign if_req_valid_o = if_req_valid_q_q;\n"
    "  assign if_req_addr_o = if_req_addr_q_q;\n"
    "  assign mem_addr_o = ex_alu_result_q_q;\n"
    "  assign mem_req_valid_o = mem_req_valid_q_q;\n"
    "  assign mem_req_addr_o = mem_req_addr_q_q;\n"
    "  assign mem_req_write_o = mem_req_write_q_q;\n"
    "  assign mem_req_wdata_o = mem_req_wdata_q_q;\n"
    "  assign mem_req_width_o = mem_req_width_q_q;\n"
    "  assign mem_read_o = ex_mem_read_obs_q_q;\n"
    "  assign mem_write_o = ex_mem_write_obs_q_q;\n"
    "  assign mem_mmio_read_valid_o = mem_mmio_read_valid_q_q;\n"
    "  assign mem_mmio_read_addr_o = mem_mmio_read_addr_q_q;\n"
